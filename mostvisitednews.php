            ...
            <section class="newest_news">
                <div class="row m-0">
                    <div class="col-12 bg-danger my-3 radius">
                        <h1 class="text-white text-center">Najcitanije vijesti</h1>
                    </div>
                    <?php
                    $results_per_page= 6 ;
                    $news3= new News();
                    $most_popular_tag = $news3->mostPopularTag();
                    $news = new News();
                    $news2 = new News();
                    $number_of_results = $news2->numNewsForTag($most_popular_tag);
                    ...
                    $news->getNewsforTag2($most_popular_tag, $this_page_result,$results_per_page);
                    if($news->numRows > 0){
                        $counter = 0;
                        while ($row = $news->res->fetch_assoc()){
                            ++$counter;
                ...
                <div class="row links justify-content-center">
                    ...
                    for($page=1;$page<=$number_of_pages;$page++){
                        ...
                        echo '<a class="px-2" href="mostvisitednews.php?page=' . $page .'&id_tag='. $most_popular_tag . '"> ' . $page .  '</a>';
