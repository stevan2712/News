<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top container" id="navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            <li class="nav-item"> <a class="nav-item nav-link" href="NewsforTag.php?id_tag=<?php $news=new News(); $id=$news->mostPopularTag(); echo $id; ?>">Najčitanije <span class="sr-only">(current)</span></a></li>
            ...
            <li class="nav-item d-none d-lg-inline"><a class="nav-link pr-1" href="NewsforTag.php?id_tag=5">Košarka</a></li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle pl-0" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
